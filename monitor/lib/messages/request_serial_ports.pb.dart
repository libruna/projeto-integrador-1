...
class ReadRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReadRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'request_serial_ports'), createEmptyInstance: create)
...
class ReadResponse extends $pb.GeneratedMessage {
  factory ReadResponse({
    $core.Iterable<$core.String>? portNames,
  }) {
    final $result = create();
    if (portNames != null) {
      $result.portNames.addAll(portNames);
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReadResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'request_serial_ports'), createEmptyInstance: create)
    ..pPS(1, _omitFieldNames ? '' : 'portNames')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$core.String> get portNames => $_getList(0);
}
...
class CreateRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'request_serial_ports'), createEmptyInstance: create)
  ...
  @$pb.TagNumber(1)
  set portname($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasPortname() => $_has(0);
  @$pb.TagNumber(1)
  void clearPortname() => clearField(1);
}
